  ...
  return (
    <main className="mx-auto max-w-4xl px-6 py-16">
      <div className="rounded-2xl bg-white p-8 shadow-md">
        ...
        <h1 className="mt-3 text-3xl font-semibold text-[#1c1c1c]">ログイン成功</h1>
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          ...
          <a
            href="/admin/orders"
            className="rounded-xl border border-[#e8e8e8] bg-white px-4 py-3 text-sm font-semibold text-[#1f3b08] shadow-sm transition hover:-translate-y-[1px] hover:shadow-md"
          >
            注文一覧を見る
          </a>
        </div>
